...
import { readCustomDocumentationLayers, type CustomDocumentationLayer } from "@shared/documentationLayers";
...
export default function DocumentationTeam() {
  ...
  useEffect(() => { const syncLayers = () => setCustomLayers(readCustomDocumentationLayers()); syncLayers(); window.addEventListener("tidc:documentation-layers", syncLayers); return () => window.removeEventListener("tidc:documentation-layers", syncLayers); }, []);
