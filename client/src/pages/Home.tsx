...
export default function Home() {
  ...
  const headerSearchResults = useMemo(() => {
    ...
    if (!needle) return [];
    const searchable = [...managedSites, ...activeSites.filter((site) => !managedSites.some((dbSite) => dbSite.id === site.id))];
  ...
  }, [activeSites, managedSites, headerSearch]);
