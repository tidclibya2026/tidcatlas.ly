...
## البريد الرئيسي لمسؤول النظام

البريد المقترح لمسؤول النظام المحلي هو `tidc2026@gmail.com`. البريد لا ينشئ الحساب تلقائيًا ولا يحدد كلمة المرور؛ يجب إنشاء الحساب مرة واحدة عبر مسار bootstrap بكلمة مرور يختارها مالك النظام، ثم استخدام البريد نفسه في تسجيل الدخول. لا تُحفظ كلمة المرور أو مفاتيح الخدمات في GitHub.
